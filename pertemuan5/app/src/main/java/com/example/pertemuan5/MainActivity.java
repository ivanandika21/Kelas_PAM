...
public class MainActivity extends AppCompatActivity implements ArticleTitleFragment.OnHeadLineSelectedListener {

    @Override
    public void onArticleSelected(int position){
        boolean isLandscape = getResources().getBoolean(R.bool.is_landscape);
        if (isLandscape){
            ArticleBodyFragment articleBodyFragment = (ArticleBodyFragment) getSupportFragmentManager().findFragmentById(R.id.content_frame).getChildFragmentManager().findFragmentById(R.id.article_body);
